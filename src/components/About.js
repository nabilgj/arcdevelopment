...
const About = props => {
    ...
    return (
        <Grid container direction="column">
                    ...
                    <Grid 
                        ...
                        <img 
                            ...
                            alt="quill pen sitting on top of the book"
                                style={{maxHeight: matchesMD ? 200 : '18em'}}
                            />
                    </Grid>
                </Grid>
            ...
            {/* Team section with avatar and paragraphs */}
            <Grid 
                item
                container
                direction="column" 
                ...
                {/* year book middle para and puppy */}
                <Grid 
                    item 
                    container
                    ...
                    <Hidden lgUp>
                        <Grid 
                            item 
                            lg 
                            style={{maxWidth: "35em", padding: "1.25em"}}>
                    ...
                    <Grid 
                        ...
                        <Grid item>
                            <img 
                                src={yearbook}
                                alt="year book about the founder"
                                style={{maxWidth: matchesMD ? 300 : undefined}} />
                        </Grid>
                        <Grid item>
                            <Typography variant="caption">
                                A page from my Sophomore yerbook!
                            </Typography>
                        </Grid>
                    </Grid>
