...
import uxnAnimation from '../animations/uxAnimation/data';
...
const CustomSoftware = (props) => {
    ...
    return (
        <Grid container direction="column">
            ...
            {/* back arrow custom software and forward arrow */}
            <Grid 
                item 
                container 
                direction="row"
                ...
                <Hidden mdDown>
                    <Grid 
                        ...
                        <IconButton 
                            ...
                            <img src={backArrow} alt="Back arrow to service page" />
                        </IconButton>
                    </Grid>
                </Hidden>
                ...
                <Hidden mdDown>
                    <Grid item className={classes.arrowContainer}>
                        <IconButton 
                            ...
                            <img src={forwardArrow} alt="Forward arrow to mobile app" />
                        </IconButton>   
                    </Grid>
                </Hidden>
            ...
            {/* save energy money time icons with title */}
            <Grid 
                item 
                container 
                direction="row" 
            ...
            {/* Digital Documents and Scale Data */}
            <Grid 
                item container 
