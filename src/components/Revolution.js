        ...
        <Grid container direction="column">
            ...
            <Grid 
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img 
                        ...
                        alt="handshake" 
                        width="100%" 
                        style={{maxWidth: matchesMD ? 500 : 300 }} />
                </Grid>
            ...
            <Grid 
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img 
                        ...
                        width="100%"
                        style={{maxWidth: matchesMD ? 700 : 500 }} />
                </Grid>
            ...
            <Grid 
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img 
                        ...
                        width="100%"
                        style={{maxWidth: matchesMD ? 500 : 200 }} />
                </Grid>
            ...
            <Grid 
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img 
                        src={design} 
                        alt="paintbrush leaving stoke of paint"
                        width="100%"
                        style={{maxWidth: matchesMD ? 700 : 500 }} />
                </Grid>
            ...
            <Grid 
                ...
                <Grid item lg style={{alignSelf: 'center'}}>
                    <img 
                        ...
                        alt="rocket image"
                        width="100%"
                        style={{maxWidth: matchesMD ? 150 : 100 }} />
                </Grid>
