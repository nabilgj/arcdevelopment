...
const Websites = props => {
    ...
    return (
        <Grid item container direction="column">
            ...
            {/* back arrow Website Development and forward arrow */}
            <Grid 
                item 
                container 
                direction="row"
                ...
                <Hidden mdDown>
                    <Grid item className={classes.arrowContainer}>
                        <IconButton 
                            ...
                            <img src={forwardArrow} alt="Forward to services app" />
                        </IconButton>   
                    </Grid>
                </Hidden>
            ...
            {/*  Analytics, magnifying glass image and paragraph */}
            <Grid 
                item 
                container 
                ...
                <Grid item>
                    <Grid item container direction="column">
                        ...
                        <Grid item>
                            <img 
                                src={ecommerce} 
                                alt="world outline made up of dollar sign" />
                        </Grid>
                    </Grid>
                </Grid>
            ...
            {/*  Search Engine Optimization, image and paragraph */}
            <Grid 
                item 
                container 
                direction={ matchesSM ? "column" : "row" }
